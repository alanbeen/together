...
public class RoleUserRecord extends TableRecordImpl<RoleUserRecord> implements Record2<Integer, Integer> {

    private static final long serialVersionUID = 1163720617;
     ...
     */
    public RoleUserRecord(Integer userId, Integer roleId) {
        super(RoleUser.ROLE_USER);
